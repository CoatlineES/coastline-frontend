...
import { CheckCircle2, AlertTriangle, HardHat, Tractor, Package } from 'lucide-react';
...
export function GanttGrid({ plan, project, expandedNodes, onUpdate, viewMode, baseDate, showBaseline, assignmentViewMode = 'MANO_OBRA', calendars, selectedCalendarId, scrollRef, onScroll, plansMap }: GanttGridProps) {
  ...
  const visibleTasks = useMemo(() => {
    ...
    const flatten = (task: ProjectTask) => {
      list.push(task);
